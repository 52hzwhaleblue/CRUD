            ...
            <from>
                ...
                <div class="form-name">
                    <div class="mb-3">
                        <label class="input-label">UserID</label>
                        <div>
                            <div class="hisWEc profile-id" data-userid="{{Session::get('userSession')->id}}">
                                <input class="input " type="text" value="{{Session::get('userSession')->id}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="profile-name" data-username="{{Session::get('userSession')->name}}">
                        <label class="input-label">Name</label>
                        <div>
                            <div class="hisWEc">
                                <input class="input " type="text" value="{{Session::get('userSession')->name}}"
                                    disabled>
                            </div>
                        </div>
                    </div>
                    <div class="profile-email" data-useremail="{{Session::get('userSession')->email}}">
                        <label class="input-label">Email</label>
                        <div>
                            <div class="hisWEc">
                                <input class="input " type="text" value="{{Session::get('userSession')->email}}"
                                    disabled>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ICUBE">
                <div class="list-item">
                    <div class="info">
                        ...
                        <div class="detail">
                            <span>Số điện thoại</span>
                            <span>{{Session::get('userSession')->phone}}</span>
                        </div>
                    </div>
                    <div class="status">
                        <button class="button active">Cập nhật</button>
                ...
                <div class="list-item">
                    <div class="info">
                        ...
                        <div class="detail">
                            <span>Địa chỉ email</span>
                            <span>{{Session::get('userSession')->email}}</span>
                        </div>
                    </div>
                    <div class="status">
                        <button class="button active">Cập nhật</button>
