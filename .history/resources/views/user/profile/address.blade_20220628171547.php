  ...
  <div class="container">
    ...
    <div class="info">
            ...
            <div class="info">
               <div class="info-left">
                  ...
                  <from>
                      <div class="form-name">
                        <div class="form-control">
                          ...
                          <div>
                            <div class="hisWEc">
                              <input class="input " type="search"  value="{{ auth()->user()->name }}" disabled>
                            </div>>
                            </div>
                          </div>
                        </div>
                ...
                <div class="form-control">
                    ...
                    <div>
                      <div class="hisWEc">
                        <input type="text" required="" name="telephone" placeholder="Nhập số điện thoại" class="Input-sc-17i9bto-0 girQwT"  value="{{ auth()->user()->phone}}" disabled>
                  </div> 
                </div>
               </div>
               <div class="form-control">
      ...
      <div class="form-control">
        ...
        <div>
          <div class="hisWEc">
            <textarea required="" name="street" rows="5" placeholder=" value={{ auth()->user()->name }}" disabled></textarea>
      </div> 
    </div>
   </div>
   <div class="form-control">
