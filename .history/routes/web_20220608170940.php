...
Route::delete('admin/criteria/destroy/{criteria}',[NewController::class,'destroy'])->name("news.destroy");
Route::get('admin/criterias/edit/{criteria}',[NewController::class,'edit'])->name("news.edit");
Route::put('admin/criteria/edit/{criteria}',[NewController::class,'update'])->name("news.update");
