...
Route::delete('admin/criteria/destroy/{news}',[NewController::class,'destroy'])->name("news.destroy");
Route::get('admin/criterias/edit/{news}',[NewController::class,'edit'])->name("news.edit");
Route::put('admin/criteria/edit/{news}',[NewController::class,'update'])->name("news.update");
