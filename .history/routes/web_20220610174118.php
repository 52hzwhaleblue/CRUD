...
Route::get('admin/video/create',[VideoController::class,'create'])->name("slide.create");
Route::post('admin/video/create',[VideoController::class,'store'])->name("slide.store");
Route::post('admin/slide/storeFileUpload',[VideoController::class,'storeFileUpload'])->name("slide.storeFileUpload");
