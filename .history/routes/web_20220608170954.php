...
Route::delete('admin/criteria/destroy/{criteria}',[NewController::class,'destroy'])->name("criteria.destroy");
Route::get('admin/criterias/edit/{criteria}',[NewController::class,'edit'])->name("criteria.edit");
Route::put('admin/criteria/edit/{criteria}',[NewController::class,'update'])->name("criteria.update");
