...
Route::get('admin//slide/edit/{criteria}',[CriteriaController::class,'edit'])->name("criteria.edit");
Route::put('admin/slide/edit/{criteria}',[CriteriaController::class,'update'])->name("criteria.update");
