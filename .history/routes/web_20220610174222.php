...
Route::get('admin//video/edit/{video}',[VideoController::class,'edit'])->name("slide.edit");
Route::put('admin/video/edit/{slide}',[VideoController::class,'update'])->name("slide.update");
