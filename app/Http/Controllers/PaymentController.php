...
class PaymentController extends Controller
{
    ...
    public function momo_payment(Request $request)
    {
        ...
        $amount = $request->get('total_momo');
        $orderId = time() ."";
        $redirectUrl = "http://127.0.0.1:8000/payment"; // đường dẫn trả về khi thanh toán thành công
...
// https://test-payment.momo.vn/v2/gateway/pay?t=TU9NT0JLVU4yMDE4MDUyOXwxNjU2MTcxOTAy
